...
class MainApp extends React.Component {
  ...
  hasApi() {
    const api = awsConfig.aws_cloud_logic_custom.filter(
      v => v.name === "requestUnicorn"
    );
  ...
  async onClick() {
    ...
    try {
      ...
      updates.push(
        `Your unicorn, ${data.Unicorn.Name} will be with you in ${
          data.Eta
        } seconds`
      );
  ...
  render() {
          ...
          <div className="configMessage">
            ...
            <div className="panel panel-default">
              ...
              <div className="panel-body">
                <p>
                  This page is not functional yet because there is no API
                  configured.
                </p>
    ...
    const updateList = this.state.updates.map((v, i) => <li key={i}>{v}</li>);
    return (
      <div>
